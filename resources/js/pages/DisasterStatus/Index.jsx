...
export default function DisasterStatusIndex({ statuses, pagination, filters, sort }) {
  const { props } = usePage()
  ...
  const handleDelete = (id) => {
    router.post(`/disaster-statuses/${id}/delete`, {}, {
      onSuccess: () => {
        setDeleteId(null)
        toast.success('Disaster status deleted successfully')
      },
    })
  }
  ...
  return (
    <>
      <Head title="Disaster Statuses | Kenenong Aid" />
      <DashboardLayout user={props.user}>
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle>Disaster Statuses</CardTitle>
                <div className="flex gap-2">
                  ...
                  <Link href="/disaster-statuses/create">
                    <Button>
                              ...
                              {columnVisibility.actions && (
                                <TableCell className="text-right">
                                  <div className="flex justify-end gap-2">
                                    <Link href={`/disaster-statuses/${status.id}`}>
              ...
              {pagination && pagination.last_page > 1 && (
                <div className="flex items-center justify-between mt-4">
                  <div className="text-sm text-muted-foreground">
                    Showing {((pagination.current_page - 1) * pagination.per_page) + 1} to {Math.min(pagination.current_page * pagination.per_page, pagination.total)} of {pagination.total} statuses
                  </div>
                  <div className="flex gap-2">
                    {pagination.current_page > 1 && (
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => router.get('/disaster-statuses', { ...filters, page: pagination.current_page - 1 }, { preserveState: true })}
                      >
                        Previous
                      </Button>
                    )}
        ...
        <AlertDialog open={deleteId !== null} onOpenChange={() => setDeleteId(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This action will delete the disaster status record. This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
