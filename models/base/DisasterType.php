...
/**
 * This is the base model class for table "t_disaster_type".
 *
 * @property integer $id
 ...
 *
 * @property \app\models\Disaster[] $disasters
 */
class DisasterType extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\models\DisasterTypeQuery the active query used by this AR class.
     */
    public static function find()
    {
