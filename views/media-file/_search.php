...
/* @var $model app\models\MediaFileSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-media-file-search">
    ...
    <?php /* echo $form->field($model, 'taken_at')->widget(\kartik\datecontrol\DateControl::classname(), [
    ...
    <?php /* echo $form->field($model, 'uploaded_by')->textInput(['placeholder' => 'Uploaded By']) */ ?>
