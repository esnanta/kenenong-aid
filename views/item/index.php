    ...
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){
                    ...
                    {return $model->itemCategory->title;}
                    else
                    {return NULL;}
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\ItemCategory::find()->asArray()->all(), 'id', 'title'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'T item category', 'id' => 'grid-item-search-item_category_id']
            ],
        'title',
        'unit',
        'description:ntext',
